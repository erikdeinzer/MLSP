...
model_cfg = {'type': 'EuroSATModel', 'backbone_cfg': {'type': 'ResNet', 'idims': 3, 'odims': 512, 'base_dims': 32, 'arch': [2, 2, 2, 2], 'dropout': 0.2}, 'head_cfg': {'type': 'FFN', 'idims': 512, 'odims': 200, 'hidden_dims': 1024, 'nlayers': 6, 'dropout': 0.2}}
...
save_dir = 'results/imagenet_large/run_20250617-152539'

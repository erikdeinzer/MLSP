...
model_cfg = {'type': 'EuroSATModel', 'backbone_cfg': {'type': 'ResNet', 'idims': 3, 'odims': 64, 'base_dims': 12, 'arch': [2, 2, 2, 2], 'dropout': 0.2}, 'head_cfg': {'type': 'FFN', 'idims': 64, 'odims': 10, 'hidden_dims': 1024, 'nlayers': 6, 'dropout': 0.2}}
...
save_dir = 'results/eurosat/run_20250617-142013'

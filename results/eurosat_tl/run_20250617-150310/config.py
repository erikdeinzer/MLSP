...
model_cfg = {'type': 'EuroSATModel', 'backbone_cfg': {'type': 'ResNet', 'idims': 3, 'odims': 64, 'base_dims': 12, 'arch': [2, 2, 2, 2], 'dropout': 0.2}, 'head_cfg': {'type': 'FFN', 'idims': 64, 'odims': 10, 'hidden_dims': 1024, 'nlayers': 6, 'dropout': 0.2}, 'ckpt': {'path': '/mmdetection3d/PRIVATE/MLSP/results/imagenet/run_20250617-110214/best_model.pth', 'load_head': False, 'load_backbone': True, 'strict': True}}
...
save_dir = 'results/eurosat_tl/run_20250617-150310'
